...
export class TransactionsCRUD implements OnInit {
  ...
  deleteTransaction(transaction: Transaction) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // Aquí iría la lógica real para eliminar la transacción
        this.messageService.add({
          severity: 'success',
          summary: 'Éxito',
  ...
  deleteSelectedTransactions() {
    this.confirmationService.confirm({
      ...
      icon: 'pi pi-exclamation-triangle',
      accept: () => {
        // Aquí iría la lógica real para eliminar las transacciones seleccionadas
        this.selectedTransactions = []; // Cambiar de null a array vacío
        this.messageService.add({
          severity: 'success',
          summary: 'Éxito',
          detail: 'Transacciones eliminadas exitosamente'
        });
        this.loadTransactions();
      }
    });
